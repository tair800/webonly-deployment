-- Recreate EquipmentFeatures with proper Unicode encoding
-- This approach deletes corrupted data and recreates it properly

-- First, let's see what we're working with
SELECT 'Current corrupted features count: ' + CAST(COUNT(*) AS VARCHAR) AS Status
...
-- Show results
SELECT 'Features recreated successfully. Total features: ' + CAST(COUNT(*) AS VARCHAR) AS Result
FROM EquipmentFeatures;
